...
/*
* When you have multiple consecutive paramaters of the same type
* you may omit the type name for the like-typed parameters
* up to the final param that declares the type
 */
...
// Call a function just as you would expect with name args
func main() {
	res := plus(1, 2)
	fmt.Println("1+2 =", res)
