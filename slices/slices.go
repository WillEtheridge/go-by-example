...
* giving a more powerful interface to sequences then arrays
 */
...
func main() {
	...
	/* To create a slice with a non-zero length, use the builtin make
	 ...
	 * One is the builtin append,
	 * which returns a slice containing one or more new values.
	 * Note that we need to accept a return value from append
	 ...
	 * of the same length as s and copy into co from s
	 */
	 ...
	 * with the syntax slice[low:high]
	 * For example, this gets a slice of
